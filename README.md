...
- `INDEX.md` — 전체 문서 목차
- `docs/codex-guide.md` — Codex CLI 핵심 개념과 표준 작업 흐름
...
- `docs/` — 가이드, 워크플로, 치트시트, 패치 예제, 샌드박스/승인 가이드
- `rules/` — 명령, 패치, 테스트, git, 커뮤니케이션, 안전 규칙
- `templates/` — 변경 요청, 디버그 런북, 리뷰 체크리스트
- `agents/` — 문서 작성, 버그 수정, 테스트 작성, 리팩터 계획용 프롬프트
