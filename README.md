...
- `INDEX.md` — 전체 목차
- `guides/codex-guide.md` — Codex CLI 핵심 개념/워크플로
- `guides/workflows.md` — 자주 쓰는 워크플로 예시(디버그/문서/리팩터)
- `guides/dual-setup.md` — Claude/Codex 공존 세팅 가이드
- `guides/cheatsheet.md` — 자주 쓰는 명령/패턴 모음
- `guides/patch-cookbook.md` — `apply_patch` 예제 모음
- `guides/sandbox-escalation.md` — 승인(에스컬레이션) 가이드
- `guides/advanced-techniques.md` — 고급 패턴(속도/안전/품질)
